  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-4 py-3 lg:flex lg:justify-between">
        <a href="#top" className="font-display text-2xl font-extrabold tracking-tight text-primary-foreground">
        ...
        <nav className="hidden items-center gap-1 font-ui text-sm font-semibold text-primary-foreground/90 lg:flex">
          <a className="rounded-md px-3 py-2 transition hover:bg-primary-foreground/10" href="#planos">
            Planos
          </a>
          ...
          <a className="rounded-md px-3 py-2 transition hover:bg-primary-foreground/10" href="#depoimentos">
            Depoimentos
          </a>
          <a className="rounded-md px-3 py-2 transition hover:bg-primary-foreground/10" href="#duvidas">
            Dúvidas
          </a>
        </nav>

        <div className="flex items-center gap-2">
          <Button variant="onbrand" className="hidden shadow-[0_0_18px_color-mix(in_oklab,var(--color-zap)_45%,transparent)] sm:inline-flex" asChild>
